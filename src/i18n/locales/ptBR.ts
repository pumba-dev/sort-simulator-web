const ptBR = {
  ...
  chart: {
    yAxis: {
      avgTimeMs: "Tempo medio (ms)",
      avgComparisons: "Comparacoes medias",
      avgMemoryKb: "Memoria media (KB)",
    },
    empty: "Sem dados para grafico",
    series: "Serie",
  ...
  comparator: {
    hero: {
      ...
      description:
        "Configure cenarios, tamanhos e replicacoes para comparar desempenho medio entre algoritmos.",
    },
    sections: {
    ...
    feedback: {
      ...
      validation: {
        ...
        selectScenario: "Selecione ao menos um cenario.",
        selectSize: "Selecione ao menos um tamanho de vetor.",
        replications: "Replicacoes deve ser maior que zero.",
        timeout: "Timeout deve ser maior que zero.",
      },
      running: "Simulacao em andamento ({completed}/{total})",
      finished: "Simulacao finalizada.",
      cancelled: "Simulacao cancelada pelo usuario.",
      errorPrefix: "Erro no comparador",
      workerError: "Erro interno no worker.",
      starting: "Iniciando simulacao...",
      pendingLoaded:
        "Configuracao carregada do historico. Clique em Iniciar para rodar novamente.",
    },
    report: {
      title: "Relatorio do Comparador de Algoritmos",
      sections: {
        header: "Cabecalho",
        environment: "Ambiente de Execucao",
      ...
      header: {
        ...
        seed: "Semente",
        replications: "Replicacoes",
        outlierRemoval: "Remocao de outliers (IQR)",
        outlierEnabled: "ativada",
        outlierDisabled: "desativada",
        timeout: "Timeout por execucao",
      ...
      aggregated: {
        columns: {
          ...
          scenario: "Cenario",
          size: "Tamanho",
          avgTime: "Tempo medio (ms)",
          avgComparisons: "Comparacoes",
          avgSwaps: "Trocas",
